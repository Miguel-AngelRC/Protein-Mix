...
<footer>
    ...
    <div id="redes">
        ...
        <a onclick="whats()"><img src="<?php echo RUTA_URL;?>/img/whatsapp.png" alt="whatsapp"></a>
        <a href="<?php echo RUTA_URL;?>/Paginas_Controller/conocenos"><p id="conocenos">Conócenos más</p></a>
    </div>
</footer>
