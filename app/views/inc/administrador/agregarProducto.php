...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" type="text/css" href="public/css/formularioProducto.css">
</head>
<body>
    <form class="form-register" method="post" action="<?php echo RUTA_URL;?>/AgregarProductoAd_Controller/registrarProducto">
        ...
        <label class="etiqueta" id="categoria">Categoria</label>
            <input class="controls" type="text" name="category" maxlength="50" placeholder="Escriba la categoría a la que pertenece el producto" required>
        <br>
        <br>
