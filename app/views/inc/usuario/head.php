...
<head>
    ...
    <link rel="stylesheet" href="<?php echo RUTA_URL;?>/css/estilos_banner.css">
    
    <!-- Estilos popup compra -->
    <link rel="stylesheet" href="<?php echo RUTA_URL;?>/css/estilos_popupCompra.css">

    <!-- Estilos tabla compra -->
    <link rel="stylesheet" href="<?php echo RUTA_URL;?>/css/tablaCompra.css"
    
    <!-- Estilos tabla popupcompra -->
    <link rel="stylesheet" href="<?php echo RUTA_URL;?>/css/estilos_popupCompraRealizada.css"
